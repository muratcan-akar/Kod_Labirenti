...
public class GobletItem : MonoBehaviour
{
    ...
    {
        // Eger itemdeki  degerler anahtardan gelen degerler ile ayni ise  anahtar degeri dikeyde arttýr ustteki itemin degerin gitsin ve animasyonlarini oynat,  itemi soldur
