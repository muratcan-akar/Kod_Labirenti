...
public class PotionItem : MonoBehaviour
{
    ...
    {
        // Eger itemdeki  degerler anahtardan gelen degerler ile ayni ise  anahtar degerini  dikeyde azalt alttaki itemin degerine gitsin ve animasyonlarini oynat,  itemi soldur
